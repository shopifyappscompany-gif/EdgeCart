...
CREATE TABLE "new_CartSettings" (
    ...
    "freebieConfettiEnabled" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_CartSettings" ("autoDiscountCode", "autoDiscountEnabled", "bannerBgColor", "bannerEnabled", "bannerText", "bannerTextColor", "createdAt", "discountEnabled", "enabled", "freebieEnabled", "freebieMinCartValue", "freebieMinQuantity", "freebieProductImageUrl", "freebieProductTitle", "freebieProductVariantId", "freebieTitle", "freebieTriggerProductIds", "freebieTriggerType", "headerText", "id", "orderNotesEnabled", "primaryColor", "scarcityBgColor", "scarcityEnabled", "scarcityMinutes", "scarcityText", "scarcityTextColor", "shop", "showVariantTitle", "tieredRewards", "tieredRewardsEnabled", "updatedAt", "upsellEnabled", "upsellMinCartValue", "upsellMinQuantity", "upsellProducts", "upsellTitle", "upsellTriggerProductIds", "upsellTriggerType") SELECT "autoDiscountCode", "autoDiscountEnabled", "bannerBgColor", "bannerEnabled", "bannerText", "bannerTextColor", "createdAt", "discountEnabled", "enabled", "freebieEnabled", "freebieMinCartValue", "freebieMinQuantity", "freebieProductImageUrl", "freebieProductTitle", "freebieProductVariantId", "freebieTitle", "freebieTriggerProductIds", "freebieTriggerType", "headerText", "id", "orderNotesEnabled", "primaryColor", "scarcityBgColor", "scarcityEnabled", "scarcityMinutes", "scarcityText", "scarcityTextColor", "shop", "showVariantTitle", "tieredRewards", "tieredRewardsEnabled", "updatedAt", "upsellEnabled", "upsellMinCartValue", "upsellMinQuantity", "upsellProducts", "upsellTitle", "upsellTriggerProductIds", "upsellTriggerType" FROM "CartSettings";
