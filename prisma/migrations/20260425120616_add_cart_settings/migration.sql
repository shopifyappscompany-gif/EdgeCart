...
INSERT INTO "new_CartSettings" ("bannerBgColor", "bannerEnabled", "bannerText", "bannerTextColor", "createdAt", "discountEnabled", "enabled", "freebieEnabled", "freebieMinCartValue", "freebieMinQuantity", "freebieProductImageUrl", "freebieProductTitle", "freebieProductVariantId", "freebieTitle", "freebieTriggerProductIds", "freebieTriggerType", "headerText", "id", "primaryColor", "shop", "updatedAt", "upsellEnabled", "upsellMinCartValue", "upsellMinQuantity", "upsellProducts", "upsellTitle", "upsellTriggerProductIds", "upsellTriggerType") SELECT "bannerBgColor", "bannerEnabled", "bannerText", "bannerTextColor", "createdAt", "discountEnabled", "enabled", "freebieEnabled", "freebieMinCartValue", "freebieMinQuantity", "freebieProductImageUrl", "freebieProductTitle", "freebieProductVariantId", "freebieTitle", "freebieTriggerProductIds", "freebieTriggerType", "headerText", "id", "primaryColor", "shop", "updatedAt", "upsellEnabled", "upsellMinCartValue", "upsellMinQuantity", "upsellProducts", "upsellTitle", "upsellTriggerProductIds", "upsellTriggerType" FROM "CartSettings";
